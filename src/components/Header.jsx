  ...
  return (
    <div className="h-[100px] relative m-0 p-0 w-full flex items-center">
      <div className="flex md:flex-1 w-full">
        <div className="sm:flex-1 items-center md:justify-start pl-8 sm:pl-16 md:pl-16 lg:pl-50  text-teal-300 text-[20px] sm:text-[25px] md:text-[25px] lg:text-[30px] font-bold hover:cursor-pointer">
          Nils-Martin Hillesund
        </div>
        <div className="md:hidden flex-1 flex items-center justify-end pr-8 sm:pr-16 text-white ">
          <Bars3Icon
      ...
      <div className="flex-1 hidden md:flex flex-row lg:gap-10 md:gap-8 md:justify-end pr-16 ">
      ...
      {menuOpen ? (
        <div className="md:hidden absolute flex flex-col  text-[20px] font-semibold text-white pt-4 pl-12 mr-8 sm:mr-16 w-50 h-50 top-[61px] right-0 bg-black z-50 rounded-br-2xl rounded-l-2xl shadow-inner drop-shadow-md shadow-teal-300">
